...
//
// 2026-09-24(사용자 지시) — CRON_SECRET은 vercel.json의 모든 크론에 공통으로
// 적용돼 그것만으로는 "정산 크론은 끄고 다른 크론만 켠다"를 표현할 수 없다.
// 정산 크론 2개에만 이 추가 게이트를 얹어 CRON_SECRET을 설정해도 기본값으로는
// 계속 꺼져 있게 한다(다른 크론 — mark-expired-invites — 는 이 플래그와 무관).
