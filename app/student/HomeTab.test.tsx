...
const cards: BoardCard[] = [
  { id: "homework:h1", sourceType: "homework", sourceId: "h1", title: "9월 과제", subtitle: null, status: "backlog", dueAt: null, href: "/student?tab=homework" },
  { id: "m1", sourceType: "manual", sourceId: "m1", title: "완료된 할일", subtitle: null, status: "done", dueAt: null, href: null },
];
...
describe("HomeTab — Home+Planner 통합(2026-09-22 사용자 지시)", () => {
  ...
  it("TODO에서 할 일을 추가/이동/삭제할 수 있다", async () => {
    ...
    const newCard: BoardCard = { id: "m2", sourceType: "manual", sourceId: "m2", title: "에세이 작성", subtitle: null, status: "backlog", dueAt: null, href: null };
