...
export async function generateBankProblemsAction(params: {
  ...
  const MATH_COMPILER_SKILLS = new Set(["linear_equations_two_var", "systems_linear", "linear_inequalities", "linear_equations_one_var", "linear_functions"]);
  if (
    ...
    const result = await runMathCompilerBatch({
      skillCode: params.skillCode as "linear_equations_two_var" | "systems_linear" | "linear_inequalities" | "linear_equations_one_var" | "linear_functions",
