...
- [ ] **(2026-09-06, 제품 오너 확정 — R11 후속)** 재원 중 기존 자녀의 학습·일정·선생님·
      ...
      동작을 만들지 않는다.
- [ ] **(2026-09-06, 이번 M4 후속 라운드 검수 중 재확인 — R11 착수 전 명시적 범위 고정)**
      위 `면담` 항목의 세부 범위를 다음과 같이 못 박는다: (1) 면담은 자녀·과목을 선택해
      ...
      **절대 생성하지 않는다** — 그 파이프라인은 신규 가입/신규 자녀 온보딩 전용이다. (5)
      ...
      이번 라운드 범위 밖으로 남아있다(`docs/CURRENT.md`에도 동일하게 명시).
