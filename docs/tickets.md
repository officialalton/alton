...
- [ ] **025-student-problemlog**: 문제 탭 — 017의 `ProblemLogTab`(세션에 종속되지 않는 컴포넌트) 재사용, 학생 포털 최상위 탭으로 배치
- [ ] **026-student-vocab**: 단어장 탭 — 013의 `VocabTab`(세션에 종속되지 않는 컴포넌트) 재사용, 학생 포털 최상위 탭으로 배치
